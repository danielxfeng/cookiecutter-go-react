...
func TestGetEnvStrOrDefault(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			if got := dependency.GetEnvStrOrDefault(testKey, defaultValue); got != tc.expected {
...
func TestGetEnvIntOrDefault(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if got := dependency.GetEnvIntOrDefault(testKey, defaultValue); got != tc.expected {
...
func TestGetEnvStrOrError(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			got, err := dependency.GetEnvStrOrError(testKey)
